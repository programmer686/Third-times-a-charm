...
export default function About() {
  return (
    <main className={styles.about__container}>
      ...
      <iframe width="700" height="330" src="https://www.youtube.com/embed/nHbjY5i7Fao" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
