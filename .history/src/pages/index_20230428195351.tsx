    ...
    <main>
      ...
      <section className={styles.overview_section2__container}>
        <div className={styles.bible_verse__container}>
          <p className={styles.bible_verse__text}>Every day they continued to meet together in the temple courts. They broke bread in their homes and ate together with glad and sincere hearts, praising God and enjoying the favor of all the people. And the Lord added to their number daily those who were being saved. - <em className={styles.bible_verse__verse}>Acts 2:46-47</em></p>
        </div>
      </section>
